...
audio-mute = Mute
audio-unmute = Unmute
audio-monitor-off = Not monitored — click to listen
audio-monitor-only = Monitored, left out of the recording — click to record it too
audio-monitor-both = Monitored and recorded — click to stop listening
