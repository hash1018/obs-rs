...
hotkey-hint = Keys work while another application has focus too, except Fullscreen and Settings. Esc keeps the current binding, Backspace clears it. Ctrl+1 to Ctrl+9 always select that Scene while this window has focus.
