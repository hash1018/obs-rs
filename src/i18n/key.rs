...
text_keys! {
    ...
    MenuEdit                      => "menu-edit";
    MenuUndo                      => "menu-undo";
    MenuUndoNothing               => "menu-undo-nothing";
    MenuRedo                      => "menu-redo";
    MenuRedoNothing               => "menu-redo-nothing";
    StatusUndone                  => "status-undone";
    StatusRedone                  => "status-redone";
    HotkeyUndo                    => "hotkey-undo";
    HotkeyRedo                    => "hotkey-redo";
    EditAddScene                  => "edit-add-scene";
    EditDeleteScene               => "edit-delete-scene";
    EditDuplicateScene            => "edit-duplicate-scene";
    EditAddSource                 => "edit-add-source";
    EditDelete                    => "edit-delete";
    EditRename                    => "edit-rename";
    EditReorder                   => "edit-reorder";
    EditTransform                 => "edit-transform";
    EditCrop                      => "edit-crop";
    ...
    EditRemoveFilter              => "edit-remove-filter";
    EditReorderFilter             => "edit-reorder-filter";
    EditFilterSettings            => "edit-filter-settings";
    EditDraw                      => "edit-draw";
    EditErase                     => "edit-erase";
    EditTransition                => "edit-transition";
    EditAddChannel                => "edit-add-channel";
    EditRemoveChannel             => "edit-remove-channel";
    EditChannelDevice             => "edit-channel-device";
